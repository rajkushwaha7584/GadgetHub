                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6 form-group"> 
                            ...
                            <select name="type" id="producttype" class="form-control" required> 
                                <option value="mobile" <%=ptype.equalsIgnoreCase("mobile")?"selcted":""%>>MOBILE</option> 
                                <option value="tv" <%=ptype.equalsIgnoreCase("tv")?"selcted":""%>>TV</option> 
                                <option value="laptop" <%=ptype.equalsIgnoreCase("laptop")?"selcted":""%>>LAPTOP</option> 
                                <option value="tablet" <%=ptype.equalsIgnoreCase("tablet")?"selcted":""%>>TABLET</option> 
                                <option value="speaker" <%=ptype.equalsIgnoreCase("speaker")?"selcted":""%>>SPEAKER</option> 
                                <option value="other" <%=ptype.equalsIgnoreCase("other")?"selcted":""%>>Some Other Appliances</option> 
                            </select> 
                        </div> 
                    </div> 
